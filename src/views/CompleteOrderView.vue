<template>
      ...
      <div class="pt-4 pb-5 flex-col gap-y-4 border-b-[3px]">
        ...
        <div class="flex justify-between">
          <div class="flex flex-col pt-3">
            ...
            <span class="text-[18px] font-semibold text-blue-400">{{ customerInfo.address }}, {{ customerInfo.state }}, {{ customerInfo.country }}</span>
          </div>
        ...
        <div class="flex justify-between">
          ...
          <div class="flex flex-col pt-3 w-[30%]">
            ...
            <div class="flex">
              ...
              <div class="text-[18px] font-semibold text-blue-400"> Ending in {{lastFourDigits}} - ${{totalPrice}}</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="flex justify-center">
        <router-link to="/">
            <div class="text-center w-32 rounded-[15px] p-1 text-black
            bg-white font-semibold drop-shadow-[10px_4px_4px_rgba(0,0,0,0.25)] mr-3">Return</div>
        </router-link>
    
        <router-link to="/cart/complete-order/receipt">
            <div class="text-center w-32 rounded-[15px] p-1 text-white
            bg-black font-semibold drop-shadow-[10px_4px_4px_rgba(0,0,0,0.25)] ml-3">Receipt</div>
        </router-link>
    </div>
  ...
  methods: {
    ...
    async saveTOJSONFile() {
        try {
            ...
            if (this.cardInfo.saveInformation) {
                formData.cardInfo = { ...this.cardInfo };
            }
